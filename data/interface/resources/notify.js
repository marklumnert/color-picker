var Notify = function () {
  const fragment = this.fragment = document.createRange().createContextualFragment(`
    ...
    <svg data-id="warning" width="16" height="16" viewBox="0 0 16 16" version="1.1">
    ...
    <svg data-id="error" width="16" height="16" viewBox="0 0 16 16" version="1.1">
    ...
    <svg data-id="info" width="16" height="16" viewBox="0 0 16 16" version="1.1">
...
Notify.prototype.display = function(message, type = 'info', delay = 30000) {
  ...
  div.querySelector('input').onclick = () => {div.remove()};
